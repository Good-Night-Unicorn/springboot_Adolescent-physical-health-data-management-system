...
public class WodeshenqingController {
    ...
    public R page(@RequestParam Map<String, Object> params,WodeshenqingEntity wodeshenqing, 
		...
		if(tableName.equals("yonghu")) {
			wodeshenqing.setYonghuzhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<WodeshenqingEntity> wrapper = new EntityWrapper<WodeshenqingEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = wodeshenqingService.selectCount(wrapper);
