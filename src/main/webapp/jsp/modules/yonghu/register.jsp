...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20210819/e4d49caf10834738a44acf9ce8c351ac.jpg) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="shengao" placeholder="身高" class="form-control-i">
							</div>
							<div class="form-group">
							<label class="label">体重</label> 
							<input  name="tizhong" placeholder="体重" class="form-control-i">
							</div>
							<div class="form-group">
