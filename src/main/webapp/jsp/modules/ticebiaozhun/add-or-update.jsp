		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑体测标准</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑体测标准</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">体测标准信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>标准分值</label>
										<input name="biaozhunfenzhi" id="biaozhunfenzhi" name="biaozhunfenzhi" class="form-control" placeholder="标准分值">
									</div>
									<div class="form-group col-md-6">
										<label>体测要求</label>
										<textarea  name="ticeyaoqiu" class="form-control" id="ticeyaoqiu" rows="3"></textarea>
									</div>
										
											<div class="form-group  col-md-12" >
												<label>备注</label>
												<div><div class="upload"><input id="beizhuupload" name="file" type="file">选择文件</div>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "ticebiaozhun/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("ticebiaozhun/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("ticebiaozhun/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("ticebiaozhun/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#biaozhunfenzhi").val(ruleForm.biaozhunfenzhi);	
			$("#ticeyaoqiu").val(ruleForm.ticeyaoqiu);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.biaozhunfenzhi != null && res.data.biaozhunfenzhi != ''){

						$("#biaozhunfenzhi").val(res.data.biaozhunfenzhi);
						$("#biaozhunfenzhi").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.ticeyaoqiu != null && res.data.ticeyaoqiu != ''){

						$("#ticeyaoqiu").val(res.data.ticeyaoqiu);
					}
