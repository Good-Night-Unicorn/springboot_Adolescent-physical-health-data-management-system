...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">回复通知管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>回复通知管理</span></li>
								<li class="breadcrumb-item active"><span>回复通知列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">回复通知列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="ticexiangmuSearch" class="form-control form-control-sm" placeholder="请输入体测项目" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('huifushijian')">回复时间<i id="huifushijianIcon" class="fa fa-sort"></i></th>
											<th>通知内容</th>
											<th>操作</th>
										</tr>
									</thead>
	...
	<script>
		...
		function search(){
			...
			if($('#ticexiangmuSearch').val() != null && $('#ticexiangmuSearch').val() != ''){
				searchForm.ticexiangmu ="%" +  $('#ticexiangmuSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var huifushijianCell  = document.createElement('td');

						  huifushijianCell.innerHTML = item.huifushijian;


			row.appendChild(huifushijianCell);
			var tongzhineirongCell  = document.createElement('td');

						  if(item.tongzhineirong != null && item.tongzhineirong != "" && item.tongzhineirong.length >= 11){
			  	tongzhineirongCell.innerHTML = item.tongzhineirong.substring(0, 10) + "..."; 
			  }else{
			  	tongzhineirongCell.innerHTML = item.tongzhineirong;
			  }


			row.appendChild(tongzhineirongCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("huifutongzhi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"huifutongzhi");
