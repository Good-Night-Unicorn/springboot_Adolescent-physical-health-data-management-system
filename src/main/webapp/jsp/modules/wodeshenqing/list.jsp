...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">我的申请管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>我的申请管理</span></li>
								<li class="breadcrumb-item active"><span>我的申请列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">我的申请列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										申请分类
									</label>
									<select name="shenqingfenlei" id="shenqingfenleiSelect" class="form-control form-control-sm" aria-controls="tableId">
										<option value=" "> </option>
										<option value="补考">补考</option>
										<option value="免测">免测</option>
										<option value="成绩修改">成绩修改</option>
									</select>
									<label>
										体测项目
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shenqingfenlei')">申请分类<i id="shenqingfenleiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			var shenqingfenleiIndex = document.getElementById("shenqingfenleiSelect").selectedIndex;
			var shenqingfenleiOptions = document.getElementById("shenqingfenleiSelect").options;
			var shenqingfenleiSelectedOption = shenqingfenleiOptions[shenqingfenleiIndex]
			if(shenqingfenleiSelectedOption.text != null && shenqingfenleiSelectedOption.text != ''){
				searchForm.shenqingfenlei = shenqingfenleiSelectedOption.text;
			}
        ...
        function getDataList() {
			http("wodeshenqing/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				shenqingfenlei : searchForm.shenqingfenlei,	
		...
		function setDataRow(item,number){
			...
			var shenqingfenleiCell  = document.createElement('td');

						  shenqingfenleiCell.innerHTML = item.shenqingfenlei; 

			row.appendChild(shenqingfenleiCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "回复"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'huifutongzhi','否','','')");
			if(crossBtnControl('回复') == true){
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("wodeshenqing/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("wodeshenqing/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("wodeshenqing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"wodeshenqing");
